...
public class ContactsPageTest extends BaseTest {
	...
	public void createNewContactTest() {
		contactsPage.createContact("olesika_22@yahoo.com", "Olesea", "Lipchenko", "SDET");
...
//	}
//	
//	@Test(priority = 3, dataProvider = "getContactsTestData", enabled=false)  //enabled=false- if you dont want any particular test case to be executed  
