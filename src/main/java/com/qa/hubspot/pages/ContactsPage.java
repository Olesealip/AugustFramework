...
public class ContactsPage extends BasePage {
	...
	public String getContactsPageTitle() {
		return elementUtil.doGetPageTitleWithIsTitle(20, Constants.LOGIN_PAGE_TITLE);
	}

	public String getContactsPageHeader() {
		elementUtil.waitForElementPresent(header, 20);
	...
	public void createContact(String emailId, String firstName, String lastName, String jobTitle) {
		...
		elementUtil.waitForElementToBeVisible(this.jobTitle, 15);
